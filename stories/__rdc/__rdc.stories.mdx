...
needed to develop with react-digit-components. If not, please add an issue here: https://github.com/cthit/react-digit-components/issues
...
Here's the font that you'll need for react-digit-components, you can add it in the `<head></head>` in public/index.html:
...
## If I find something missing or unclear in the documentation?

Contact your nearest digIT member, or create a issue at the github for react-digit-components.
