...
import { DigitHeader, DigitDesign, DigitLayout, DigitText, DigitTabs, DigitGammaActionsDummy, DigitButton } from "../../src";

<Meta
    title="DigitHeader"
    component={DigitHeader}
    decorators={[
        storyFn => <div style={{ height: "600px", maxHeight: "600px" }}>{storyFn()}</div>
    ]}
/>
        ...
        {() => {
            ...
            return (
                <DigitHeader 
                    ...
                    headerHeight="150px"
                    backgroundImage={"url(https://images.unsplash.com/photo-1576502200272-341a4b8d5ebb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80)"}
                    titleColor="black"
                />
            );
        }}
                    ...
                    renderCustomHeader={() => (
                        <DigitLayout.Row flex="1" justifyContent="center">
                            <DigitButton 
                                ...
                                onClick={() => console.log("Think with Portals")}
                            />
                        </DigitLayout.Row>
                    )}
                    renderMain={() => (
