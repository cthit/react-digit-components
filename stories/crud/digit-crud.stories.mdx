        ...
        {() => {
            ...
            return (
                <DigitCRUD  path=""
                            ...
                            statusRenders={{401: (error, reset) => <div style={{height: "200px"}}>{error != null && error.response.status} - <DigitButton text="reset" onClick={reset}/></div>}}
                />
            );
        }}
    </Story>
        ...
        {() => {
            ...
            return (
                <DigitCRUD  path=""
                            ...
                            statusRenders={{500: (error, reset) => <div style={{height: "200px"}}>{error != null && error.response.status} - <DigitButton text="reset" onClick={reset}/></div>}}
                />
            );
        }}
    </Story>
        ...
        {() => {
            ...
            return (
                <DigitCRUD  path=""
                            ...
                            onUpdate={response => console.log("UPDATED")}
                            statusHandlers={{401:() => console.log("401 nope")}}                            
                            statusRenders={{401: (error, reset) => <div style={{height: "300px"}}>No access :( <DigitButton text="reset" onClick={reset}/></div>}}
                />
            );
        }}
    </Story>
