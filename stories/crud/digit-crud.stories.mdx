...
## DigitCRUD only readAll on401/404/500 and render401/404/500 
        ...
        {() => {
            ...
            return (
                <DigitCRUD  path=""
                            ...
                            on401={() => console.log("401 nope")}
                            render401={(error, reset) => <div style={{height: "200px"}}>{error != null && error.response.status} - <DigitButton text="reset" onClick={reset}/></div>}
                />
            );
        }}
    </Story>
        ...
        {() => {
            ...
            return (
                <DigitCRUD  path=""
                            ...
                            useKeyTextsInUpperLabel
                            onDelete={response => console.log("DELETED")}
                            render500={(error, reset) => <div style={{height: "200px"}}>{error != null && error.response.status} - <DigitButton text="reset" onClick={reset}/></div>}
                />
            );
        }}
    </Story>
        ...
        {() => {
            ...
            return (
                <DigitCRUD  path=""
                            ...
                            onUpdate={response => console.log("UPDATED")}
                            render401={(error, reset) => <div style={{height: "300px"}}>No access :( <DigitButton text="reset" onClick={reset}/></div>}
                />
            );
        }}
    </Story>
