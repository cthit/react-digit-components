...
<Meta title="Forms/DigitEditDataCard" component={DigitEditDataCard} />
...
<Preview>
    ...
    <Story name="Other values initial with subtitle">
        <DigitEditDataCard
            ...
            titleText={"Title"}
            subtitleText={
                "This can be a rather long subtitle, if you for example would like to give some background to why this form exists and what it's used for. "
            }
            submitText={"Send"}
...
## Other components with extraButton
